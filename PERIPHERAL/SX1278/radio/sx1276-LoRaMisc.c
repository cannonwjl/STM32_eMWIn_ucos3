...
void SX1276LoRaSetRFFrequency( uint32_t freq )//设置RF频率
{
...
uint32_t SX1276LoRaGetRFFrequency( void )//读RF频率
{
...
void SX1276LoRaSetSignalBandwidth( uint8_t bw )//带宽
{
...
void SX1276LoRaSetSpreadingFactor( uint8_t factor )//扩频因子
{
...
void SX1276LoRaSetErrorCoding( uint8_t value )//纠错
{
    SX1276Read( REG_LR_MODEMCONFIG1, &SX1276LR->RegModemConfig1 );
...
void SX1276LoRaSetImplicitHeaderOn( bool enable )//报头
{
    SX1276Read( REG_LR_MODEMCONFIG1, &SX1276LR->RegModemConfig1 );
...
void SX1276LoRaSetRxSingleOn( bool enable )//单一接收
{
...
void SX1276LoRaSetTxPacketTimeout( uint32_t value )//设置发送超时
{
