...
void SX1276Init( void )
{
    ...
    SX1276Reset( );
	 ...
	 { 
		 ...
		 {
			 cnt=0;
//			 LORA_PWEN_OFF; delay_ms(100);
//			 LORA_PWEN_ON;delay_ms(60);
			 SX1276Read(0x06,&TempReg);
			 if(TempReg==0x6C)
			 {
				 printf("Hard SPI OK\r\n");
...
//	SX1276SetReset_IO(RADIO_RESET_OFF);
    // Wait 6ms
    startTick = GET_TICK_COUNT( );
...
//        printf("\r REG_LR_OPMODE=%d ",SX1276LR->RegOpMode);
...
//        printf("\r REG_LR_DIOMAPPING1=%d ",SX1276LR->RegDioMapping1);
