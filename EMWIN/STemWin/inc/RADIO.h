...
//{
//    void ( *Init )( void );//SX1276Init()
//    void ( *Reset )( void );//SX1276Reset()
//    void ( *StartRx )( void );//SX1276StartRx()
//    void ( *GetRxPacket )( void *buffer, u16 *size );//SX1276GetRxPacket()
//    void ( *SetTxPacket )( const void *buffer, u16 size );//SX1276SetTxPacket()
//    u32 ( *Process )( void );//SX1276Process()
//}tRadioDriver;
