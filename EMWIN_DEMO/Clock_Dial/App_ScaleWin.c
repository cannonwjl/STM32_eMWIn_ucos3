...
//    }, 
//		{
//      250, 260, 0, 0,  75, 200, 100, 200, 311,  10, 1, 13,  5,  7, 10,
//        2, 2, 2, 2,  80, 1, 0, 0, 25, 34, 40, 16, 25, 0x73F, 0, 0, "speed", 0, 0,
//      {{{0xFF, 0xFF, 0xC0}}, {{0x00, 0xFF, 0xFF}}, {{0x95, 0x64, 0xFF, 0xB0}},
//       {{0x00, 0x70, 0x00}}, {{0x90, 0x90, 0x00}}, {{0xAA, 0x00, 0x00}}, {{0xFF, 0xFF, 0xFF}}}
//    }, 
//		{
//      120, 260, 0, 0,  75, 200, 124, 257, 311,  8, 1, 13,  5,  7, 10,
	...
	{
    {
      ...
      {{{0xFF, 0xFF, 0xC0}}, {{0x00, 0xFF, 0xFF}}, {{0x80, 0xFF, 0x00, 0x80}},
       {{0x90, 0x90, 0x00}}, {{0x00, 0x70, 0x00}}, {{0x90, 0x90, 0x00}}, {{0xFF, 0xFF, 0xFF}}}
		...
		{
      130, 250, 0, 0, 100, 260, 130, 130, 331, 20, 5, 13,  5,  7, 13,
        2, 2, 2, 2,  80, 4, 1, 0, 35, 44, 50, 16, 25, 0x73F, 0, 0, "Speed", 0, 0,
      {{{0xFF, 0xFF, 0xC0}}, {{0x00, 0xFF, 0xFF}}, {{0x95, 0x64, 0xFF, 0xB0}},
       {{0x00, 0x70, 0x00}}, {{0x90, 0x90, 0x00}}, {{0xAA, 0x00, 0x00}}, {{0xFF, 0xFF, 0xFF}}}
    }, 
		{
...
//  x y  0 0 表盘的左侧边界  表盘的右侧边界    表盘整体的大小X  表盘整体的大小Y  颜色设置  表格外的数字最大范围
//未   刻度的长短   未   有颜色部分的宽度  数字的位置
/*
**********************************************************************************************************
                                  仪表上面的指针坐标
**********************************************************************************************************
