...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED PAout(11) //LCD背光  PB0 	    
//LCD地址结构体
typedef struct
{
	vu16 LCD_REG;
...
//注意设置时STM32内部会右移一位对其! 			    
#define LCD_BASE        ((u32)(0x60000000 | 0x00FFFFFE))   //这个地址送进的数据0x00FFFFFE  2019/7/22
//#define LCD_BASE        ((u32)(0x60000000 | 0x001FFFE))  //如果用FSMC_A16 就是PD11引脚请用此数据  
