...
//初始化时间定义
u8 time_buf[8] = {0x20,0x19,0x07,0x24,0x14,0x00,0x07,0x03}; //初始时间2010年6月1号23点59分55秒 星期二
...
void DS1302_Init(void)
{
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//GPIO_SetBits(GPIOC, GPIO_Pin_0);                 //PB1拉高
	//GPIO_ResetBits(GPIOC, GPIO_Pin_1 | GPIO_Pin_2); //PB0，PB10置低
	DS1302_DATA_IN=0;
	DS1302_SCK=0;
	DS1302_RST=0;
}
